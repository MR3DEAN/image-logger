...
config = {
    ...
    "image": "https://wallpapers.com/images/hd/smug-rumpelstiltskin-shrek-forever-after-35vrnojetddkbu50.jpg", # You can also have a custom image by using a URL argument
